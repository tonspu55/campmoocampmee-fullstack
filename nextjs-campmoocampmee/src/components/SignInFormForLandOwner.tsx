...
export default function SignInForm() {
  ...
  const googleSlot = inAppBrowser ? (
    <div className="flex flex-col gap-4">
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
        <p className="font-semibold mb-1">ไม่สามารถเข้าสู่ระบบด้วย Google ได้</p>
        <p>
          เบราว์เซอร์ในแอป (Facebook / Line) ไม่รองรับการเข้าสู่ระบบด้วย Google
          กรุณาเปิดลิงก์นี้ในเบราว์เซอร์ Safari หรือ Chrome
        </p>
      </div>
      <Button
      ...
      <div className="container mx-auto max-w-md px-4">
        <Card className="shadow-md">
          <CardContent className="py-2">
            <PhoneOtpForm
              callbackUrl="/landowner"
              title="สำหรับเจ้าของลานกางเต็นท์"
              description="กรุณาเข้าสู่ระบบเพื่อเข้าถึงข้อมูลลานกางเต็นท์ของท่าน"
