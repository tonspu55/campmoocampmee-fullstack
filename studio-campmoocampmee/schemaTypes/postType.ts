...
export const postType = defineType({
  ...
  fields: [
    ...
    // ── รายละเอียดเพิ่มเติมและสิ่งอำนวยความสะดวก ───────────────────────────────────────────
    defineField({
      name: 'otherBenefits',
      title: 'รายละเอียดเพิ่มเติมและสิ่งอำนวยความสะดวก',
      type: 'object',
      group: 'benefits',
      fields: [
        defineField({name: 'checkIn', title: 'Check In', type: 'string'}),
        defineField({name: 'checkOut', title: 'Check Out', type: 'string'}),
        defineField({name: 'priceOfStay', title: 'ราคา', type: 'string'}),
        defineField({name: 'cabin', title: 'มีอุปกรณ์ให้เช่าไหม? มีอะไรบ้าง', type: 'string'}),
        ...
        defineField({name: 'nature', title: 'วิวที่พักเป็นอย่างไร', type: 'string'}),
        defineField({name: 'noNoise', title: 'งดใช้เสียงดังหลังเวลา', type: 'string'}),
      ],
    }),
  ],
})
