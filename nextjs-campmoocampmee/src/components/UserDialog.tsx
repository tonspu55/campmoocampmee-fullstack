    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="p-4 sm:max-w-md z-999">
        {status === 'loading' || checkingLandOwner ? (
          ...
          <>
            <DialogHeader>
              <DialogTitle>บัญชีของฉัน</DialogTitle>
              <DialogDescription>
              ...
              {inAppBrowser ? (
                <>
                  <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                    ...
                    <p>เบราว์เซอร์ในแอป (Facebook / Line) ไม่รองรับการเข้าสู่ระบบด้วย Google กรุณาเปิดในเบราว์เซอร์ Safari หรือ Chrome</p>
                  </div>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="max-w-52.5 mx-auto gap-2 w-full text-base"
                  >
                    {copied ? (
                ...
                <>
                  <Button
                    ...
                    disabled={loading}
                    variant="outline"
                    className="max-w-52.5 mx-auto gap-3 w-full text-base"
                  >
                    {loading ? (
