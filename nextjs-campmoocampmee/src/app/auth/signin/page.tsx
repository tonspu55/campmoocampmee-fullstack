              ...
              <div className="flex flex-col gap-4">
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                  ...
                  <p>
                    ...
                    ไม่รองรับการเข้าสู่ระบบด้วย Google
                ...
                <div className="flex flex-col gap-2 text-sm text-muted-foreground text-center">
                  <p className="font-medium text-foreground">
                    วิธีเปิดในเบราว์เซอร์ภายนอก
                  </p>
                  <p>
                    กด <span className="font-semibold">ปุ่ม 3 จุด (...)</span>{" "}
                    หรือ <span className="font-semibold">เมนู</span> แล้วเลือก{" "}
